...
function getProperty($var){
	...
	if($var == 'dutyaccount') Return '154201670';
	if($var == 'accounttovalidate') Return '154201670';
	if($var == 'meter') Return '105005340';
	if($var == 'key') Return 'OT8ytfTHg3VdH0vO';
	if($var == 'password') Return 'NEvwkA5UxEGnZlqwcpsoDUdBT';
	...
	if($var == 'trackingnumber') Return '9261292700352518704197 ';
